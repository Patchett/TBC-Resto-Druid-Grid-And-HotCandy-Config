...
L:RegisterTranslations("enUS", function()
        return {
            ["Kalecgos Curse"] = true,
            ["Color < 13 sec"] = true,
            ["Color when someone has had the curse for less than 13 seconds"] = true,
            ["Color >= 13 sec"] = true,
            ["Color when someone has had the curse for 13 or more seconds"] = true,
        }
    end)
...
L:RegisterTranslations("deDE", function()
        return {
             ...
             ["Color < 13 sec"] = "Farbe <13 Sekunden",
             ["Color when someone has had the curse for less than 13 seconds"] ="Farbe  falls jemand den Debuff weniger als 13 Sekunden hat",
             ["Color >= 13 sec"] = "Farbe >= 13 Sekunden",
             ["Color when someone has had the curse for 13 or more seconds"] = "Farbe  falls jemand den Debuff länger als 13 Sekunden hat",
        }
    end)
...
L:RegisterTranslations("koKR", function()
        return {
            ...
            ["Color < 13 sec"] = "색상 < 13 초",
            ["Color when someone has had the curse for less than 13 seconds"] = "13초 미만의 저주 색상을 설정합니다.",
            ["Color >= 13 sec"] = "색상 >= 13 초",
            ["Color when someone has had the curse for 13 or more seconds"] = "13초 이상의 저주 색상을 설정합니다.",
        }
    end)
...
L:RegisterTranslations("zhCN", function()
        return {
            ...
            ["Color < 13 sec"] = "高亮小于13秒",
            ["Color when someone has had the curse for less than 13 seconds"] = "高亮当有人诅咒时间小于13秒。",
            ["Color >= 13 sec"] = "高亮大于等于13秒",
            ["Color when someone has had the curse for 13 or more seconds"] = "高亮当有人诅咒时间大于等于13秒。",
        }
    end)
...
L:RegisterTranslations("zhTW", function()
        return {
            ...
            ["Color < 13 sec"] = "高亮小於13秒",
            ["Color when someone has had the curse for less than 13 seconds"] = "高亮當有人詛咒時間小於13秒。",
            ["Color >= 13 sec"] = "高亮大於等於13秒",
            ["Color when someone has had the curse for 13 or more seconds"] = "高亮當有人詛咒時間大於等於13秒。",
        }
    end)
...
local curseOptions = {
    ...
    ["color1"] = {
        type = "color",
        name = L["Color < 13 sec"],
        desc = L["Color when someone has had the curse for less than 13 seconds"],
        order = 88,
        hasAlpha = true,
        get = function ()
    ...
    ["color2"] = {
        type = "color",
        name = L["Color >= 13 sec"],
        desc = L["Color when someone has had the curse for 13 or more seconds"],
        order = 89,
        hasAlpha = true,
        get = function ()
...
function GridStatusKalecgos:DebuffTimer()
    ...
    for unit,time in pairs(self._timers) do
        ...
        -- use color2 if unit has had the debuff for 13 or more seconds
        if elapsed >= 13 then
